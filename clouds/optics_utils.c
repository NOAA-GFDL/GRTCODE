                      ...
                      double const * band_limits)
{
    ...
    self->bands = (double *)malloc(sizeof(double)*num_bands);
    memcpy(self->bands, bands, sizeof(double)*num_bands);
    self->band_limits = (double *)malloc(sizeof(double)*num_bands*2);
    memcpy(self->band_limits, band_limits, sizeof(double)*num_bands*2);
    self->extinction_coefficient = (double *)malloc(sizeof(double)*num_bands);
    self->single_scatter_albedo = (double *)malloc(sizeof(double)*num_bands);
    self->asymmetry_factor = (double *)malloc(sizeof(double)*num_bands);
    return;
}
